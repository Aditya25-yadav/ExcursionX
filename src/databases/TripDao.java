 ...
 *
 * FIX: All methods now check conn == null BEFORE creating PreparedStatement,
 *      preventing NullPointerException when the database is unreachable.
 */
public class TripDao {
    ...
    public boolean createTrip(Trip trip) {
        ...
        try (Connection conn = DBconnection.getConnection()) {
            if (conn == null) { System.err.println("[TripDao] No DB connection."); return false; }
    ...
    public ArrayList<String[]> getManifestList(int tripId) {
        ...
        // FIX: `class` is a MySQL keyword — must be backtick-quoted in explicit column list
